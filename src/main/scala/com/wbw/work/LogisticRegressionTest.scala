...
object LogisticRegressionTest {
  def main(args: Array[String]): Unit = {
    ...
    */
    ...
    println("recall = " + evaluator.setMetricName("recallByLabel").evaluate(result))
    println("fMeasure = " + evaluator.setMetricName("fMeasureByLabel").evaluate(result))
